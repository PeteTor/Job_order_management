...
$stmt = $pdo->prepare("SELECT * FROM job_orders WHERE status = 'in-progress'");
$stmt->execute();
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li>
                <a href="in_progress.php" class="active">
    ...
    <div class="content">
        <div class="admin-reports">
            <table>
                <tr>
                    <th style="border-top: 5px solid #06b6d4;">No.</th>
                    <th style="border-top: 5px solid #06b6d4;">Job Order Title</th>
                    <th style="border-top: 5px solid #06b6d4;">Dept./Requester Name</th>
                    <th style="border-top: 5px solid #06b6d4;">Description</th>
                    <th style="border-top: 5px solid #06b6d4;">Task Category</th>
                    <th style="border-top: 5px solid #06b6d4;">Labor Cost Estimate</th>
                    <th style="border-top: 5px solid #06b6d4;">Material Cost Estimate</th>
                    <th style="border-top: 5px solid #06b6d4;">Status</th>
                </tr>
                <?php foreach ($job_orders as $job): ?>
                    <tr>
                        ...
                        <td>
                            <div style="background-color:  #06b6d4;
                            color: white;
                            font-weight: bold;
                            padding: 10px 12px;
