...
$stmt = $pdo->prepare("SELECT * FROM job_orders WHERE status = 'on-hold'");
$stmt->execute();
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li>
                <a href="on_hold.php" class="active">
    ...
    <div class="content">
        <div class="admin-reports">
            <table>
                <tr>
                    <th style="border-top:5px solid #ffcc00;">No.</th>
                    <th style="border-top:5px solid #ffcc00;">Job Order Title</th>
                    <th style="border-top:5px solid #ffcc00;">Dept./Requester Name</th>
                    <th style="border-top:5px solid #ffcc00;">Description</th>
                    <th style="border-top:5px solid #ffcc00;">Task Category</th>
                    <th style="border-top:5px solid #ffcc00;">Labor Cost Estimate</th>
                    <th style="border-top:5px solid #ffcc00;">Material Cost Estimate</th>
                    <th style="border-top:5px solid #ffcc00;">Status</th>
                </tr>
